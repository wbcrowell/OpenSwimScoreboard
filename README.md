...
This is a personal project, so there's no installer, but you can download the compiled binaries [here](https://drive.google.com/drive/folders/1SboR40AXwv9tc6P45s9SqzhQ0KKlGsnU?usp=sharing). Please note that this is unsigned code 
(code signing certificates are brutally expensive), so you will see a warning box when you try to run it. You will need to click through the warning to get it to work. If this makes you uncomfortable, download the code and compile it yourself.
